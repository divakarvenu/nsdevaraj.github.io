(function() {
    ...
    ERNO.extend(ERNO.Cube.prototype, {
        ...
        immediateTwist: function(a) {
          var clet = a.command.toUpperCase()
           if(clet != 'X' || clet!= 'Y' || clet != 'Z' || clet!='S' || clet!='M' || clet!='E'){
            if (a.command == a.command.toUpperCase()) {
            $("#movesdisplay").find('h1').append(" "+a.command.toUpperCase());
            }
            if (a.command == a.command.toLowerCase()){
            $("#movesdisplay").find('h1').append(" "+a.command+"'");
            }}
