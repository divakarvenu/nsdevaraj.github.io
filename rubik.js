...
YUI.add('rubik', function(Y) {
  ...
  Rubik.prototype = {
    _init: function(cfg) {
      ...
      this._resolve = Y.one(cfg.solve || '.resolve');
    ...
    _bind: function() {
      ...
      this._container.on('gesturemovestart', this._onTouchCube, {
        preventDefault: true
      }, this);
      this._container.on('gesturemove', this._onMoveCube, {
        preventDefault: true
      }, this);
      this._container.on('gesturemoveend', this._onEndCube, {
        preventDefault: true
      }, this);
      ...
      this._solve.on('gesturemovestart', this._solveFake, {
        preventDefault: true
      }, this);
      this._resolve.on('gesturemovestart', this._resolveFake, {
        preventDefault: true
      }, this);
      this._undo.on('gesturemovestart', this._undoMove, {
        preventDefault: true
      }, this);
      this._redo.on('gesturemovestart', this._redoMove, {
        preventDefault: true
      }, this);
      if (Y.UA.mobile) { 
    ...
    _resolveFake: function() {
      window.location.reload(false);
    },
    _solveFake: function() {
	  this._queue.size = 17;
	  this._queue.current = 16;
	  this._queue._queue= [{"face":"C","slice":"M","rotate":"right"},{"face":"C","slice":"E","rotate":"right"},{"face":"L","slice":"M","rotate":"right"},{"face":"U","slice":"E","rotate":"right"},{"face":"C","slice":"E","rotate":"right"},{"face":"C","slice":"M","rotate":"right"},{"face":"C","slice":"E","rotate":"right"},{"face":"D","slice":"E","rotate":"right"},{"face":"C","slice":"M","rotate":"right"},{"face":"U","slice":"E","rotate":"right"},{"face":"C","slice":"E","rotate":"right"},{"face":"D","slice":"E","rotate":"right"},{"face":"C","slice":"M","rotate":"right"},{"face":"D","slice":"E","rotate":"right"},{"face":"C","slice":"E","rotate":"left"},{"face":"C","slice":"M","rotate":"right"},{"face":"C","slice":"E","rotate":"right"}];
    ...
    _onEndCube: function(evt) {
      ...
      this._tempXY = {
        x: this._tempXY.x % 360,
        y: this._tempXY.y % 360
      }; // to get controlled the degrees
      ...
      switch (true) {
        ...
        case parts[2] != "up" && parts[2] != "down" && mHorizontal:
          movement = {
            face: parts[4].charAt(0),
            slice: parts[4].charAt(1),
            rotate: rotateX
          };
          break;
        ...
        case (parts[2] == "up" || parts[2] == "down") && mHorizontal && deg >= -45 && deg < 45:
          ...
          movement = {
            face: parts[5].charAt(0),
            slice: parts[5].charAt(1),
            rotate: rotateX
          };
          break;
